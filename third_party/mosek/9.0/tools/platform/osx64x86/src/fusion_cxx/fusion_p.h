...
static  int string_to_value_value(const std::string &  _6503);
static  int string_to_streamtype_value(const std::string &  _6504);
static  int string_to_startpointtype_value(const std::string &  _6505);
static  int string_to_stakey_value(const std::string &  _6506);
static  int string_to_sparam_value(const std::string &  _6507);
static  int string_to_solveform_value(const std::string &  _6508);
static  int string_to_soltype_value(const std::string &  _6509);
static  int string_to_solsta_value(const std::string &  _6510);
static  int string_to_solitem_value(const std::string &  _6511);
static  int string_to_simseltype_value(const std::string &  _6512);
static  int string_to_sensitivitytype_value(const std::string &  _6513);
static  int string_to_scalingmethod_value(const std::string &  _6514);
static  int string_to_scalingtype_value(const std::string &  _6515);
static  int string_to_rescodetype_value(const std::string &  _6516);
static  int string_to_rescode_value(const std::string &  _6517);
static  int string_to_xmlwriteroutputtype_value(const std::string &  _6518);
static  int string_to_prosta_value(const std::string &  _6519);
static  int string_to_problemtype_value(const std::string &  _6520);
static  int string_to_problemitem_value(const std::string &  _6521);
static  int string_to_parametertype_value(const std::string &  _6522);
static  int string_to_presolvemode_value(const std::string &  _6523);
static  int string_to_orderingtype_value(const std::string &  _6524);
static  int string_to_optimizertype_value(const std::string &  _6525);
static  int string_to_onoffkey_value(const std::string &  _6526);
static  int string_to_objsense_value(const std::string &  _6527);
static  int string_to_mpsformat_value(const std::string &  _6528);
static  int string_to_mionodeseltype_value(const std::string &  _6529);
static  int string_to_miomode_value(const std::string &  _6530);
static  int string_to_miocontsoltype_value(const std::string &  _6531);
static  int string_to_branchdir_value(const std::string &  _6532);
static  int string_to_iparam_value(const std::string &  _6533);
static  int string_to_iomode_value(const std::string &  _6534);
static  int string_to_internal_iinf_value(const std::string &  _6535);
static  int string_to_internal_dinf_value(const std::string &  _6536);
static  int string_to_inftype_value(const std::string &  _6537);
static  int string_to_iinfitem_value(const std::string &  _6538);
static  int string_to_internal_liinf_value(const std::string &  _6539);
static  int string_to_liinfitem_value(const std::string &  _6540);
static  int string_to_dparam_value(const std::string &  _6541);
static  int string_to_feature_value(const std::string &  _6542);
static  int string_to_dinfitem_value(const std::string &  _6543);
static  int string_to_dataformat_value(const std::string &  _6544);
static  int string_to_symmattype_value(const std::string &  _6545);
static  int string_to_scopr_value(const std::string &  _6546);
static  int string_to_nametype_value(const std::string &  _6547);
static  int string_to_conetype_value(const std::string &  _6548);
static  int string_to_compresstype_value(const std::string &  _6549);
static  int string_to_checkconvexitytype_value(const std::string &  _6550);
static  int string_to_callbackcode_value(const std::string &  _6551);
static  int string_to_purify_value(const std::string &  _6552);
static  int string_to_intpnthotstart_value(const std::string &  _6553);
static  int string_to_simhotstart_value(const std::string &  _6554);
static  int string_to_simdupvec_value(const std::string &  _6555);
static  int string_to_simreform_value(const std::string &  _6556);
static  int string_to_uplo_value(const std::string &  _6557);
static  int string_to_transpose_value(const std::string &  _6558);
static  int string_to_simdegen_value(const std::string &  _6559);
static  int string_to_mark_value(const std::string &  _6560);
static  int string_to_boundkey_value(const std::string &  _6561);
static  int string_to_basindtype_value(const std::string &  _6562);
static  int string_to_language_value(const std::string &  _6563);
}; // struct Parameters;
